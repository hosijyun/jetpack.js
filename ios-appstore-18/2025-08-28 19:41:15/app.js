...
break}case"LinkBlock":{const n=function(e,t,n){const r=q(t,gj)
if(!r)return null
const o=new kq(r),i=q(t,"urlTitle")
let s=q(t,IN)
s||(s=o.host)
const a=[KS,eN,"music.apple.com","books.apple.com","podcasts.apple.com","watch-app.cdn-apple.com","tv.apple.com"]
let c=!1
for(const e of a)o.host.endsWith(e)&&(c=!0)
const l=new OH(r)
Lf(e,l,{targetType:aj,pageInformation:n.metricsPageInformation,id:`${n.index}`,locationTracker:n.metricsLocationTracker})
const u=new lz(i,s,l,c)
qa(0,u,n)
const d=new Ez(JE)
return d.items=[u],d}(e,t,a);(0,Tg.isSome)(n)&&(l.push(n),a.hasFocusableElements=!0)
...
return null!==(e=this.implementation.boolean("enable-licenses"))&&void 0!==e&&e}}pV.type=(0,vg.makeMetatype)("app-store:bag-wrapper")
